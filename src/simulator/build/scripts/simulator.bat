...
set CLASSPATH=%APP_HOME%\lib\simulator.jar;%APP_HOME%\lib\core-1.0.0.jar


@rem Execute simulator
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SIMULATOR_OPTS%  -classpath "%CLASSPATH%" frc.robotSimulator.Main %*
...
if not ""=="%SIMULATOR_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
